 ...
 */
class getUrlStatsRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\UrlStatsRepository' shared autowired service.
     *
     * @return \App\Repository\UrlStatsRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'UrlStatsRepository.php';

        return $container->privates['App\\Repository\\UrlStatsRepository'] = new \App\Repository\UrlStatsRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
