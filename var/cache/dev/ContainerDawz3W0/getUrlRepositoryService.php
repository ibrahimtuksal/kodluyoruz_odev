 ...
 */
class getUrlRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\UrlRepository' shared autowired service.
     *
     * @return \App\Repository\UrlRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'UrlRepository.php';

        return $container->privates['App\\Repository\\UrlRepository'] = new \App\Repository\UrlRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
